...
//        public DynamicsClient(IOptions<DynamicsContextOptions> options, ILogger<DynamicsClient> logger)
//        {
...
//        public async Task<JObject> GetAsync(string setName, Action<IQuery> configureDelegate)
//        {
//            var queryBuilder = new Query();
